...
func convertSchema(schema models.Schema) map[string]interface{} {
...
func (p *Provider) CreateMessage(
	...
	for _, msg := range messages {
		...
		if msg.IsToolResponse() {
			slog.Debug("processing tool response",
	...
	slog.Debug("sending messages to OpenAI",
...
func (p *Provider) CreateToolResponse(
	...
	slog.Debug("creating tool response",
...
// ToolCallWrapper implements models.ToolCall
